...
class Profile
{
    ...
    register_post_type(
      ...
      array(
        ...
        'labels' => array(
          ...
          'not_found_in_trash' => __( 'No templates found in Trash.', 'post-from-email' ),
          ...
          'item_update' => __( 'Template updated', 'post-from-email' ),
  ...
  /**
   * HTML for the first metabox, username, password, all that.
   *
        ...
        <table class="credentials">
            <tr>
                ...
                <td colspan="2" class="cred">
                    <select id="timing"
                            name="credentials[timing]"> <?php echo implode( PHP_EOL, $timings_options ) ?></select>
                </td>
            </tr>
            <tr>
                <td>
      ...
      <table class="postlog">
          ...
          if( 0 === $count ) {
            ?>
              <td colspan="3">
                  <p>
                    <?php esc_html_e( 'No activity yet.', 'post-from-email' ); ?>
                  </p>
              </td>
            <?php
          }
    ...
    ?>
      <div data-target="filter" class="dialog popup help-popup hidden"
          ...
          <p>
            ...
            <?php esc_html_e( 'If you do this you can apply a different template, with different categories and tags, to each sender.', 'post-from-email' ) ?>
          </p>
          <p>
   ...
   *
   * @param WP_POST $post The post for the current profile.
   *
   * @return void
   */
